var buildExtensions_lvl4 = {
    run: function(room) {

        if (!room.memory.extensions_lvl4) {
            room.memory.extensions_lvl4 = {built: false};
        };

        if (room.memory.extensions_lvl4.built == true) {
            return;
        }
        ...
        if (buildarea) {
            ...
            for (block in buildarea) {
                if (builtcount < 10) {
                    ...
                    room.memory.extensions_lvl4.built = true;
                }
            }
        }
    }
...
module.exports = buildExtensions_lvl4;